...
let total = GAMES_JSON.reduce((accumulator, currentValue) => accumulator + currentValue.backers, 0);
...
let totalraised = GAMES_JSON.reduce((accumulator, currentValue) => accumulator + currentValue.pledged, 0);
...
let unfunded = GAMES_JSON.filter((game) => game.pledged < game.goal);
let count = unfunded.length;
// create a string that explains the number of unfunded games using the ternary operator
const string1 = `Currently, ${count} games remain unfunded`;
const string2 = `Currently, ${count} game remains unfunded`;
const finalString = count > 1 ? string1 : string2;
// create a new DOM element containing the template string and append it to the description container
const desc = document.createElement('p');
desc.innerHTML = finalString;
descriptionContainer.appendChild(desc);
/************************************************************************************
 * Challenge 7: Select & display the top 2 game"s
